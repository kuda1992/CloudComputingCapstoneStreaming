...
if __name__ == "__main__":
    ...
    top10AirportsPerAirportSchema = StructType([StructField('Airport', StringType(), True), StructField('Carrier', StringType(), True), StructField('Average Departure Delay', FloatType(), True)])
