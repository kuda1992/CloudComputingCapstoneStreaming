...
if __name__ == "__main__":
    ...
    spark = SparkSession \
        .builder \
        .appName("Top Airports For Each Airport") \
        .getOrCreate()
    ...
    top10AirportsPerAirportSchema = StructType([StructField('Origin Airport', StringType(), True), StructField('Dest Airport', StringType(), True), StructField('Average Arrival Delay', FloatType(), True)])
